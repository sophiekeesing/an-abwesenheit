<template>
  <div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 mx-auto">
      <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Schüler Dashboard</h2>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
      <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Klasse auswählen</h3>
      <div class="flex items-center space-x-4">
        ...
        <div v-if="authStore.user?.classId" class="text-sm text-gray-600 dark:text-gray-400">
          Aktuelle Klasse: <span class="font-medium">{{ authStore.user.classId }}</span>
        </div>
      </div>
    </div>
    ...
    <!-- My Absences -->
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
      <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Meine Fehlzeiten</h3>

      <div v-if="myAbsences.length === 0" class="text-gray-500 dark:text-gray-400 text-center py-8">
        ...
        >
          <div class="flex justify-between items-start">
            <div class="flex-1">
              ...
              >
                <p class="text-gray-600 dark:text-gray-400 font-medium mb-1">Notiz vom Lehrer:</p>
                <p class="text-gray-800 dark:text-gray-200">{{ absence.teacherNotes }}</p>
              </div>

              <div v-if="absence.documentPath" class="mt-2">
                <p class="text-xs text-gray-500 dark:text-gray-400">📎 Dokument angehängt</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
          ...
          <div class="text-sm text-gray-600 dark:text-gray-400">Gesamt Fehlzeiten</div>
        </div>
...
const updateClass = () => {
  if (selectedClass.value) {
    authStore.updateUserClass(selectedClass.value)
  }
}
